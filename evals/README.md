...
```powershell
python scripts\evaluate.py --dataset evals\questions.v2.jsonl --split dev --strategy hybrid-rerank --limit 5 --output evals\report.json
# 中文问题检索英文论文时，同时评测英文查询改写：
python scripts\evaluate.py --dataset evals\questions.v2.jsonl --split dev --strategy hybrid-rerank --limit 5 --rewrite --output evals\report-rewrite.json
```
...
```powershell
python scripts\evaluate.py --dataset evals\questions.v2.jsonl --split dev --strategy bm25 --limit 5 --output evals\report-dev-bm25.json
python scripts\evaluate.py --dataset evals\questions.v2.jsonl --split dev --strategy dense --limit 5 --output evals\report-dev-dense.json
python scripts\evaluate.py --dataset evals\questions.v2.jsonl --split dev --strategy hybrid --limit 5 --output evals\report-dev-hybrid.json
python scripts\evaluate.py --dataset evals\questions.v2.jsonl --split dev --strategy hybrid-rerank --limit 5 --output evals\report-dev-hybrid-rerank.json
```
...
```powershell
python scripts\evaluate.py --dataset evals\questions.v2.jsonl --split dev --mode rag --strategy hybrid-rerank --limit 5 --output evals\report-dev-rag.json
```
